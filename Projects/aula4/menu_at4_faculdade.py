...
valorProdu = float(input('Agora que voçê escolheu o produto digite o valor correspondente:R$')) # Variável para receber o preço
quantProdu = int(input('Quantas unidades foram escolhidas:')) #Variável para receber s #
subtotal = valorProdu * quantProdu
